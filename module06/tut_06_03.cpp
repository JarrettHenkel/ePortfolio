...
namespace
{
    ...
    // camera
    Camera gCamera(glm::vec3(-5.0f, 5.0f, 7.0f));
    ...
    glm::vec3 gLightColor2(1.0f, 0.1f, 0.1f);
...
const GLchar* cubeFragmentShaderSource = GLSL(440,
    ...
    void main()
    {
        ...
        vec3 diffuse2 = impact2 * lightColor2 * 0.1; // Generate diffuse light color
        ...
        vec3 phong = (ambient + diffuse + diffuse2 + specular) * textureColor.xyz;
...
void URender()
{
    ...
    glm::mat4 view = glm::lookAt(gCamera.Position, targetPosition, upVector);
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] = {
        ...
        //Bottom Face        // Normals             // Texture coords
