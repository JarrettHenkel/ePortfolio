...
void UCreateMesh(GLMesh &mesh)
{
    ...
    GLfloat verts[] = {
        // First triangle, right angle at the first vertex
        -0.9f, -0.5f, 0.0f, // First vertex (right angle)
        1.0f, 0.0f, 0.0f, 1.0f, // Color red

        -0.9f, 0.5f, 0.0f, // Second vertex
        0.0f, 0.0f, 1.0f, 1.0f, // Color blue

        -0.0f, -0.5f, 0.0f, // Third vertex
        0.0f, 1.0f, 0.0f, 1.0f, // Color green

        // Second triangle, right angle at the second vertex
        0.0f, -0.5f, 0.0f, // First vertex
        1.0f, 0.0f, 0.0f, 1.0f, // Color red

        0.9f, -0.5f, 0.0f, // Second vertex (right angle)
        0.0f, 1.0f, 0.0f, 1.0f, // Color green

        0.0f, -1.5f, 0.0f, // Third vertex
        0.0f, 0.0f, 1.0f, 1.0f, // Color blue
    };
